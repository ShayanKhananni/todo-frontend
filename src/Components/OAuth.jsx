...
function OAuth() {
  ...
  return (
    <>
    <button onClick={handleGoogleAuth} class=" mt-3 font-primary flex gap-2 items-center justify-center w-full  font-semibold text-white bg-red-700 border-0 py-2 px-8 focus:outline-none hover:bg-blue-500 rounded text-md" type='button'><FaGoogle />Continue With Google</button> 
    </>
  )
}
